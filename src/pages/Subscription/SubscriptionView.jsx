    ...
    return(
        ...
        <div className="subView-container">
            <div className="subViewData-conatiner">
                <h1><Link to="/subList">:--</Link> SUBSCRIPTION VIEW!</h1>
             <h3 className="title-view">title</h3>
             <input type="text" value={subView?.title || ""} placeholder='ENTER YOUR TITLE' disabled/>
             <h3 className="Amount-view">Amount</h3>
             <input type="text" value={subView?.Amount || ""} placeholder='ENTER YOUR AMOUNT' disabled/>
             <h3 className="description-view">description</h3>
             <input type="text" value={subView?.description || ""} placeholder='ENTER YOUR DESCRIPTION' disabled/>
             <h3 className="subscriptionType-view">subscriptionType</h3>
                  <select
            className="select-subType"
            value={subView?.subscriptionType}
          >
