    ...
    <>
      <div className="Faq-container">
        <div className="Faq-Data">
          <h1>FAQ LIST!</h1>
          <button className="btnFaq-add"><Link to="/faq">+ADD</Link></button>
          <table>
          <thead>
            <tr>
              <th>Sr No.</th>
            ...
            {faqList.length === 0 ? (
              ...
              faqList.map((item, index) => (
                <tr key={item.id}>
                  ...
                  <td>{item.answer}</td>
                  <td>
                    <button className="btn-delete" onClick={() => FaqDelete(item.id)}>
                      <Trash2 size={18} />
                    </button>
                    <button className="btn-view"  onClick={()=>navigate(`/faq/view//${item.id}`)}>
                      <Eye size={18} />
                    </button>
                    <button className="btn-edit" onClick={()=>navigate(`/faq/Edit/${item.id}`)}>
                      <PencilIcon size={18} />
                    </button>
                  </td>
                </tr>
